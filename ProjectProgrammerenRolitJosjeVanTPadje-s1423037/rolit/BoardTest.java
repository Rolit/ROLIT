...
public class BoardTest {
    ...
    public void testGetField(){
    	...
    	assertEquals("controlleer of veld GEEL is", Mark1.BLAUW, mark1);
    	
    	Mark1 mark2 = b.getField(3, 4);
    	assertEquals("controlleer of veld BLAUW is", Mark1.GEEL, mark2);
    ...
    public void testRecolorFields(){
    	...
    	assertEquals("Kijken of 3, 5 rood is", Mark1.ROOD, mark0);
    	assertEquals("Kijken of 3, 4 rood is", Mark1.ROOD, mark1);
    	assertEquals("Kijken of 5, 5 rood is", Mark1.ROOD, mark2);
    	...
    	assertEquals("Kijken of 2, 5 rood is", Mark1.GEEL, mark6);
    	assertEquals("Kijken of 3, 4 rood is", Mark1.GEEL, mark7);
    	assertEquals("Kijken of 2, 3 rood is", Mark1.GEEL, mark8);
    	...
    	System.out.println(mogelijkeVelden);
    	assertEquals("Kijekn of 5, 2 blauw is", Mark1.BLAUW, mark14);
    	assertEquals("Kijken of 4, 3 blauw is", Mark1.BLAUW, mark15);
