...
import protocollen.CommonProtocol;
...
public class Start implements ActionListener {
	...
	private int opties = CommonProtocol.SUPPORTS_BAREBONE;
	private int versie;
	private JButton standAloneButton;
	private int state;
	Game game = new Game();
	...
	public JPanel startPanel(){
		...
		standAloneButton = new JButton("Start stand alone Game");
		startPanel.add(standAloneButton);
		standAloneButton.addActionListener(this);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource() == standAloneButton){
			startFrame.dispose();
			new GUI(game);
		}
	...
	public String processInput(String inputLine) {
		...
		if (state == 0){
			theOutput = "hello " + nameField.getText() + " " + opties + " " + versie;
			state = 1;
		}
