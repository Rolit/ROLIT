...
public class Commandos {
	public enum ArgumentType{
		Integer, Boolean, String, MultiString;
	}
	
	private static final HashMap<String, ArgumentType[]> serverArgumentTypes = new LinkedHashMap<String, ArgumentType[]>();
	private static final HashMap<String, ArgumentType[]> clientArgumentTypes = new LinkedHashMap<String, ArgumentType[]>();
	...
	static {
        ...
        public Commandos(String command, Object...arguments){
        ...
        public void writeTo(PrintStream output) throws IOException{
        	...
        	for(Object argument : arguments){
        		output.print(StandardProtocol.Delimiter);
        		
        		if(argument instanceof String[]){
        			output.print(Strings.join(StandardProtocol.Delimiter, (String[]) argument));
        		}
        		else{
        	...
        	output.print(StandardProtocol.EndOfLine);
	        output.flush();
        ...
        private static Object parse(String data, ArgumentType arg) throws ProtocolException {
            switch(arg) {
                ...
                case Boolean:
                    if(!data.equals(StandardProtocol.BooleanTrue) && !data.equals(StandardProtocol.BooleanFalse)) {
                        throw new ProtocolException("Boolean must be true or false.", ServerProtocol.ERROR_GENERIC);
                    }

                    return data.equals(StandardProtocol.BooleanTrue);
                case String:
                    return data;
                case MultiString:
        ...
        public static Commandos readFromClient(BufferedReader input) throws IOException, ProtocolException {
            return readFrom(input, clientArgumentTypes);
        }

        public static Commandos readFromServer(BufferedReader input) throws IOException, ProtocolException {
            return readFrom(input, serverArgumentTypes);
        }

        private static Commandos readFrom(BufferedReader input, HashMap<String, ArgumentType[]> argumentTypes) throws IOException, ProtocolException {
            String[] parts = input.readLine().split(StandardProtocol.Delimiter);
            ...
            return new Commandos(command, result);
        }
	}
